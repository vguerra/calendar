...
ad_form -name add-new-item-type -action item-type-new -has_submit 1 -form {
	...
	col1 {
        ...
        col2 {
            label ""
	    display_template {
		<a href="@item_types.col2_url@">@item_types.col2@</a>
	    }
        }
    }
...
foreach item_type $item_types {
    ...
    multirow append item_types "$type" "[_ acs-kernel.common_delete]" "item-type-delete?calendar_id=$calendar_id&item_type_id=$item_type_id"
}