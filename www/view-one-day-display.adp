	<table id="cal-table-day" cellpadding="0" cellspacing="1" border="0" width="@day_width@@width_units@"  style="min-width: 300px;">
    ...
    <tbody>
      <tr>
        <td headers="hours" style="vertical-align: top; width:@bump_right_delta@@width_units@"> <div class="day-time-1"><p><a href="@grid_first_add_url@" title="#calendar.Add_item_beginning_at#">@grid_first_hour@</a></p></div></td>
        <td headers="events" style="vertical-align: top;" class="day-event-1" valign="top">
